...
def train_nlp_pipeline():
    ...
    tensor_path = os.path.join(current_dir, "../../data/processed/nlp/body/nlp_train_tensor.pt")
    weights_path = os.path.join(current_dir, "../../models/omnifinance/nlp_ae_v1_body.pth")
