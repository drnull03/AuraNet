...
return (
<div className="bg-white border border-brand-border rounded-2xl shadow-sm p-5 flex flex-col h-[700px]" id="network-topology-card">
...
{/* REACTIVE EVENT TICKER - Fixed height with infinite scroll */}
<div className="mt-4 bg-slate-900 rounded-xl font-mono text-[10.5px] py-3 px-4 flex items-start gap-3 shadow-md border border-slate-800 relative overflow-hidden shrink-0 h-[140px]">
